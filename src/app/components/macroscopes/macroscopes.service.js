...
//            'url': 'https://www.youtube.com/embed/CP-TcDtSFDI',
            ...
            'descriptionLong':'<p>The movements of hundreds of thousands of vessels were captured using shore and satellite-based tracking data from FleetMon, a company that provides live vessel tracking, and its partner, Luxspace.</p><p>Many cargo ships, tankers, ferries, cruise ships, yachts and tugs carry transponders that transmit their locations. That data is then available to amateur ship spotters and maritime businesses alike through the interactive <em> FleetMon Explorer </em> &nbsp;tool. Using the tool you can follow the flow of jet fuel and agricultural commodities around the globe, track a fleet of cruise ships in real time, or monitor traffic at ports around the world.</p>',
      ...
      },
      {
        ...
        'data': [
          ...
          },
          {
            ...
            'type': 'iframe',
            'descriptionTitle':'<p>Drag a book and see how it is connected to other publications.</p>',
